...
#ifndef MOGCOIN_KEYSTORE_H
#define MOGCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/mogcoin/bips/blob/master/bip-0013.mediawiki
