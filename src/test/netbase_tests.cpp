...
{
    BOOST_CHECK(TestSplitHost("www.mogcoincore.org", "www.mogcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.mogcoincore.org]", "www.mogcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.mogcoincore.org:80", "www.mogcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mogcoincore.org]:80", "www.mogcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:31898", "127.0.0.1", 31898));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:31898", "127.0.0.1", 31898));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:31898", "::ffff:127.0.0.1", 31898));
    BOOST_CHECK(TestSplitHost("[::]:31898", "::", 31898));
    BOOST_CHECK(TestSplitHost("::31898", "::31898", -1));
    BOOST_CHECK(TestSplitHost(":31898", "", 31898));
    BOOST_CHECK(TestSplitHost("[]:31898", "", 31898));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:31898", "127.0.0.1:31898"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:31898", "[::]:31898"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
