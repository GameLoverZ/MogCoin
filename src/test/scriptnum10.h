...
#ifndef MOGCOIN_TEST_SCRIPTNUM10_H
#define MOGCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MogCoin Core 0.10.0, for cross-comparison.
 */
public:
