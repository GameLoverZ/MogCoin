...
#ifndef MOGCOIN_INTERFACES_NODE_H
#define MOGCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a mogcoin node (mogcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MOGCOIN_INTERFACES_NODE_H
