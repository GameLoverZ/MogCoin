...
#ifndef MOGCOIN_QT_MOGCOINUNITS_H
#define MOGCOIN_QT_MOGCOINUNITS_H
...
/** MogCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MogCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MogCoinUnits(QObject *parent);

    /** MogCoin units.
      @note Source: https://en.mogcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MOC,
...
typedef MogCoinUnits::Unit MogCoinUnit;

#endif // MOGCOIN_QT_MOGCOINUNITS_H
