    ...
    mapper(0)
{
    ...
    ui->mogcoinAtStartup->setToolTip(ui->mogcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->mogcoinAtStartup->setText(ui->mogcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openMogCoinConfButton->setToolTip(ui->openMogCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MogCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mogcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMogCoinConfButton_clicked()
{
