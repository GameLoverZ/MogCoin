...
static void SetupMogCoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mogcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mogcoin-tx [options] <hex-tx> [commands]  Update hex-encoded mogcoin transaction\n" +
            "or:     mogcoin-tx [options] -create [commands]   Create hex-encoded mogcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mogcoin transaction
