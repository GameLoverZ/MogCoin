 ...
 */
#ifndef MOGCOIN_UTIL_H
#define MOGCOIN_UTIL_H
...
extern const char * const MOGCOIN_CONF_FILENAME;
extern const char * const MOGCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("mogcoin-%s", name);
