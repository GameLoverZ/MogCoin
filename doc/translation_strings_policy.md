...
This document provides guidelines for internationalization of the MogCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mogcoin_en.ts` remains unchanged.
