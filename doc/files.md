...
* mogcoin.conf: contains configuration settings for mogcoind or mogcoin-qt
* mogcoind.pid: stores the process id of mogcoind while running
...
* debug.log: contains debug information and general logging generated by mogcoind or mogcoin-qt
