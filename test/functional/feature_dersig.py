...
class BIP66Test(MogCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # mogcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and mogcoind produces more specific reject
            # reasons.
