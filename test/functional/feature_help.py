...
"""Verify that starting mogcoin with -h works as expected."""

from test_framework.test_framework import MogCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MogCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mogcoin with -h for help text")
        ...
        self.log.info("Start mogcoin with -version for version information")
        ...
        self.log.info("Start mogcoind with -fakearg to make sure it does not start")
