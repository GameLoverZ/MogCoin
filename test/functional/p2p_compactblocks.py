...
# TestP2PConn: A peer we use to send messages to mogcoind, and store responses.
...
class CompactBlocksTest(MogCoinTestFramework):
    ...
    # This test actually causes mogcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that mogcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for mogcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # mogcoind will not send blocktxn responses for blocks whose height is
